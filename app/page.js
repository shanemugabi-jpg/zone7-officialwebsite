        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {menuItems.map((item) => (
              ...
              >
                <div className="mb-6 flex h-40 items-center justify-center overflow-hidden rounded-3xl bg-gradient-to-br from-yellow-500/20 to-black text-gray-500">
                  <img
                    src={item.image}
                    alt={item.title}
                    className="h-40 w-full rounded-3xl object-cover transition duration-500 group-hover:scale-110"
                  />
                </div>
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid gap-4 md:grid-cols-4">
            {galleryImages.map((image, index) => (
              <div
                key={image}
                className="flex h-56 items-center justify-center overflow-hidden rounded-3xl border border-yellow-500/20 bg-black text-gray-500"
              >
                <img
                  src={image}
                  alt={`Zone 7 gallery ${index + 1}`}
